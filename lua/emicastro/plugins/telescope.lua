return { -- Fuzzy Finder (files, lsp, etc)
  ...
  dependencies = {
    ...
    { -- If encountering errors, see telescope-fzf-native README for installation instructions
      -- Fuzzy Finder Algorithm which dependencies local deps to be built. Only loads if `make` is available
  ...
  config = function()
    ...
    keymap.set("n", "<leader>ft", builtin.builtin, { desc = "[F]ind [S]elect Telescope" })
    ...
    keymap.set("n", "<leader>fWs", function()
      local word = vim.fn.expand("<cWORD>")
      builtin.grep_string({ search = word })
    end, { desc = "[F]ind the [W]hole [s]tring" })
  ...
  -- TODO: dap extension for telescope
